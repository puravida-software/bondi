...
# Well formed, and Bondi cannot carry it out: port 1 on the box's own loopback
# refuses immediately, so the pull fails at once rather than being waited out.
printf '{"job": "image-gate-probe", "image": "127.0.0.1:1/absent:0.0.1"}' \
